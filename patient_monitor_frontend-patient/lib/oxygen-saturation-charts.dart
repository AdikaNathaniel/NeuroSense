...
class _OxygenSaturationPageState extends State<OxygenSaturationPage> {
  ...
  Future<void> fetchOxygenSaturationData() async {
    setState(() {
      isLoading = true;
    });
    ...
    try {
      ...
      final url = "https://patient-monitor-backend-patient.fly.dev/api/v1/heltec-live-vitals/charts/oxygen-saturation?days=$days";
  ...
  Widget buildOxygenSaturationChart() {
          ...
          child: Padding(
            ...
            child: LineChart(
              LineChartData(
                ...
                minY: minValue > 20 ? minValue * 0.9 : 0,
                maxY: maxValue < 100 ? maxValue * 1.05 : 100,
                    ...
                    getTooltipItems: (List<LineBarSpot> touchedSpots) {
                      return touchedSpots.map((spot) {
                        ...
                        final date = index >= 0 && index < labels.length 
                            ? labels[index].toString() 
                            : 'N/A';
                        final saturation = spot.y.toStringAsFixed(1);
